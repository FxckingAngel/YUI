...
const ko: Record<string, string> = {
  ...
  "filler.more": "더 보기",
  "filler.long_wait_label": "오래 걸릴 때 대사",
  "filler.long_wait_sub": "반복이 끝나도 답이 안 오면 한 번만 재생",
  "filler.long_wait_aria": "오래 걸릴 때 대사 목록",
  "filler.timeout_label": "타임아웃 대사",
  "filler.timeout_sub": "응답이 너무 오래 걸려서 포기했을 때 재생",
  "filler.timeout_aria": "타임아웃 대사 목록",
  "filler.unreachable_label": "연결 끊김 대사",
  ...
  "vrm.rename": "이름 바꾸기",
  "vrm.remove": "삭제",
  "vrm.remove_confirm": "삭제할까요?",
  "vrm.remove_confirm_aria": "삭제할까요? {name}",
  ...
  "speaker.remove": "삭제",
  "speaker.remove_confirm": "삭제할까요?",
  "speaker.remove_confirm_aria": "삭제할까요? {name}",
  ...
  "express_motion.section": "표현 모션",
  "express_motion.sub": "대화 중 캐릭터가 고를 수 있는 동작 · 끄면 어휘에서 빠져요",
  "express_motion.group_aria": "표현 모션 선택",
  "express_motion.count": "{on}/{total} 켜짐",
  "express_motion.master_aria": "{group} 전체",
  "express_motion.group.reaction": "감정 리액션",
  "express_motion.group.action": "동작 · 상태",
  "express_motion.group.other": "기타",
  "express_motion.happy.label": "기쁨",
  "express_motion.happy.sub": "기뻐하는 리액션",
  "express_motion.laugh.label": "웃음",
  "express_motion.laugh.sub": "소리 내어 웃는 리액션",
  "express_motion.embarrassed.label": "부끄러움",
  "express_motion.embarrassed.sub": "손가락을 만지작거리는 수줍은 몸짓",
  "express_motion.sheepish.label": "멋쩍음",
  "express_motion.sheepish.sub": "머리에 손을 얹는 어색한 몸짓",
  "express_motion.calm.label": "차분",
  "express_motion.calm.sub": "손을 모으고 서 있는 차분한 몸짓",
  "express_motion.sulk.label": "삐침",
