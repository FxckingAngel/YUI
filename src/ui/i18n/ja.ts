...
const ja: Record<string, string> = {
  ...
  "vrm.rename": "名前を変更",
  "vrm.remove": "削除",
  "vrm.remove_confirm": "削除しますか？",
  "vrm.remove_confirm_aria": "削除しますか？ {name}",
  ...
  "speaker.remove": "削除",
  "speaker.remove_confirm": "削除しますか？",
  "speaker.remove_confirm_aria": "削除しますか？ {name}",
  ...
  "express_motion.section": "表現モーション",
  "express_motion.sub": "会話中にキャラが選べる動き · オフにすると候補から外れます",
  "express_motion.group_aria": "表現モーションの選択",
  "express_motion.count": "{on}/{total} オン",
  "express_motion.master_aria": "{group} 全体",
  "express_motion.group.reaction": "感情リアクション",
  "express_motion.group.action": "動作 · 状態",
  "express_motion.group.other": "その他",
  "express_motion.happy.label": "よろこび",
  "express_motion.happy.sub": "うれしそうなリアクション",
  "express_motion.laugh.label": "笑い",
  "express_motion.laugh.sub": "声を出して笑うリアクション",
  "express_motion.embarrassed.label": "照れ",
  "express_motion.embarrassed.sub": "指先をいじる恥ずかしそうな仕草",
  "express_motion.sheepish.label": "きまり悪さ",
  "express_motion.sheepish.sub": "頭に手をやる気まずい仕草",
  "express_motion.calm.label": "おだやか",
  "express_motion.calm.sub": "手を前で組んで立つ落ち着いた仕草",
  "express_motion.sulk.label": "すね",
